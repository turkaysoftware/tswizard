...
namespace TSWizard{
    internal class TSModules{
        ...
        public class TS_SoftwareCopyrightDate{
            public static string ts_scd_preloader = string.Format("\u00a9 2025-{0}, {1}.", DateTime.Now.Year, Application.CompanyName);
        }
        // SETTINGS MODULE PATHS
        // ======================================================================================================
        public static readonly string ts_sf = StartupPath + @"\" + Application.ProductName.Replace(" ", string.Empty) + "Settings.ini";
        ...
        // READ LANG PATHS
        // ======================================================================================================
        public static readonly string ts_lf = Path.Combine(StartupPath, "tswizard_langs");  // Main Path
        ...
        public class TS_ThemeEngine{
            ...
            public static readonly Dictionary<string, Color> LightTheme = new Dictionary<string, Color>{
                ...
                { "EncryphixFE", Color.FromArgb(90, 111, 141) },
                { "EncryphixFEHover", Color.FromArgb(100, 124, 156) },
                { "GlowFE", Color.FromArgb(54, 95, 146) },
                { "GlowFEHover", Color.FromArgb(63, 109, 165) },
                { "VCardixFE", Color.FromArgb(20, 120, 109) },
                { "VCardixFEHover", Color.FromArgb(22, 133, 120) },
                { "VimeraFE", Color.FromArgb(118, 85, 177) },
                ...
                { "BtnUpdateBG", Color.FromArgb(118, 85, 177) },
                { "BtnUpdateBGHover", Color.FromArgb(133, 96, 197) },
            ...
            public static readonly Dictionary<string, Color> DarkTheme = new Dictionary<string, Color>{
                ...
                // UI COLOR
                { "UIBGColor1", Color.FromArgb(27, 30, 34) },
                { "UIBGColor2", Color.FromArgb(34, 38, 44) },
                ...
                { "UIFEColor5", Color.FromArgb(27, 30, 34) },
                //
                ...
                { "DataGridSelectionBGColor", Color.FromArgb(34, 38, 44) },
                { "DataGridSelectionFEColor", Color.WhiteSmoke },
                // SOFTWARE COLORS
                { "AstelFE", Color.FromArgb(38, 187, 33) },
                { "AstelFEHover", Color.FromArgb(43, 206, 38) },
                { "EncryphixFE", Color.FromArgb(125, 154, 197) },
                { "EncryphixFEHover", Color.FromArgb(139, 170, 216) },
                { "GlowFE", Color.FromArgb(88, 153, 233) },
                { "GlowFEHover", Color.FromArgb(93, 165, 253) },
                { "VCardixFE", Color.FromArgb(71, 158, 161) },
                { "VCardixFEHover", Color.FromArgb(76, 170, 173) },
                { "VimeraFE", Color.FromArgb(164, 118, 243) },
                ...
                { "BtnUpdateBG", Color.FromArgb(164, 118, 243) },
                { "BtnUpdateBGHover", Color.FromArgb(176, 136, 245)  },
                { "BtnDownloadBG", Color.FromArgb(38, 187, 33) },
                { "BtnDownloadBGHover", Color.FromArgb(43, 206, 38) },
                { "BtnDeleteBG", Color.FromArgb(255, 77, 77) },
                { "BtnDeleteBGHover", Color.FromArgb(255, 88, 88)},
                { "BtnFEColor1", Color.FromArgb(27, 30, 34) },
            };
            // THEME SWITCHER
            // ====================================
