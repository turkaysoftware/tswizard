...
namespace TSWizard{
    public partial class TSWizardAbout : Form{
        public TSWizardAbout(){
            InitializeComponent();
            //
        ...
        // ABOUT LOAD
        // ======================================================================================================
        private async void TSWizardAbout_Load(object sender, EventArgs e){
            try{
        ...
        public void About_preloader(){
            try{
                ...
                //
                BackColor = TS_ThemeEngine.ColorMode(TSWizardMain.theme, "TSBT_BGColor2");
                PanelTxt.BackColor = TS_ThemeEngine.ColorMode(TSWizardMain.theme, "TSBT_BGColor2");
                //
                LabelDeveloper.ForeColor = TS_ThemeEngine.ColorMode(TSWizardMain.theme, "TSBT_LabelColor1");
                LabelSoftware.ForeColor = TS_ThemeEngine.ColorMode(TSWizardMain.theme, "TSBT_AccentColor");
                LabelVersion.ForeColor = TS_ThemeEngine.ColorMode(TSWizardMain.theme, "TSBT_LabelColor2");
                LabelCopyright.ForeColor = TS_ThemeEngine.ColorMode(TSWizardMain.theme, "TSBT_LabelColor2");
                //
                foreach (Control ui_buttons in PanelTxt.Controls){
                    if (ui_buttons is Button about_button){
                        about_button.ForeColor = TS_ThemeEngine.ColorMode(TSWizardMain.theme, "UIFEColor5");
                        about_button.BackColor = TS_ThemeEngine.ColorMode(TSWizardMain.theme, "AccentColor");
                        about_button.FlatAppearance.BorderColor = TS_ThemeEngine.ColorMode(TSWizardMain.theme, "AccentColor");
                        about_button.FlatAppearance.MouseDownBackColor = TS_ThemeEngine.ColorMode(TSWizardMain.theme, "AccentColor");
                        about_button.FlatAppearance.MouseOverBackColor = TS_ThemeEngine.ColorMode(TSWizardMain.theme, "AccentColorHover");
                    }
                }
                //
                TSImageRenderer(About_WebsiteBtn, TSWizardMain.theme == 1 ? Properties.Resources.ct_website_light : Properties.Resources.ct_website_dark, 18, ContentAlignment.MiddleRight);
                TSImageRenderer(About_GitHubBtn, TSWizardMain.theme == 1 ? Properties.Resources.ct_github_light : Properties.Resources.ct_github_dark, 18, ContentAlignment.MiddleRight);
                TSImageRenderer(About_DonateBtn, TSWizardMain.theme == 1 ? Properties.Resources.tm_donate_mc_light : Properties.Resources.tm_donate_mc_dark, 18, ContentAlignment.MiddleRight);
                //
                AboutTable.BackgroundColor = TS_ThemeEngine.ColorMode(TSWizardMain.theme, "DataGridBGColor");
                AboutTable.GridColor = TS_ThemeEngine.ColorMode(TSWizardMain.theme, "DataGridColor");
                AboutTable.DefaultCellStyle.BackColor = TS_ThemeEngine.ColorMode(TSWizardMain.theme, "DataGridBGColor");
                AboutTable.DefaultCellStyle.ForeColor = TS_ThemeEngine.ColorMode(TSWizardMain.theme, "DataGridFEColor");
                AboutTable.AlternatingRowsDefaultCellStyle.BackColor = TS_ThemeEngine.ColorMode(TSWizardMain.theme, "DataGridAlternatingColor");
                AboutTable.ColumnHeadersDefaultCellStyle.BackColor = TS_ThemeEngine.ColorMode(TSWizardMain.theme, "AccentColor");
                AboutTable.ColumnHeadersDefaultCellStyle.SelectionBackColor = TS_ThemeEngine.ColorMode(TSWizardMain.theme, "DataGridSelectionBGColor");
                AboutTable.ColumnHeadersDefaultCellStyle.ForeColor = TS_ThemeEngine.ColorMode(TSWizardMain.theme, "UIFEColor5");
                AboutTable.DefaultCellStyle.SelectionBackColor = TS_ThemeEngine.ColorMode(TSWizardMain.theme, "DataGridSelectionBGColor");
                AboutTable.DefaultCellStyle.SelectionForeColor = TS_ThemeEngine.ColorMode(TSWizardMain.theme, "UIFEColor5");
                //
                CloseAboutBtn.BackColor = TS_ThemeEngine.ColorMode(TSWizardMain.theme, "TSBT_CloseBG");
                CloseAboutBtn.FlatAppearance.BorderColor = TS_ThemeEngine.ColorMode(TSWizardMain.theme, "TSBT_CloseBG");
                CloseAboutBtn.FlatAppearance.MouseOverBackColor = TS_ThemeEngine.ColorMode(TSWizardMain.theme, "TSBT_CloseBGHover");
                CloseAboutBtn.FlatAppearance.MouseDownBackColor = TS_ThemeEngine.ColorMode(TSWizardMain.theme, "TSBT_CloseBGHover");
                // ======================================================================================================
                // TEXTS
