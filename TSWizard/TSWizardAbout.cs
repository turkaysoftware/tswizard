    ...
    public partial class TSWizardAbout : Form{
        ...
        public void about_preloader(){
            try{
                ...
                BackColor = TS_ThemeEngine.ColorMode(TS_Wizard.theme, "TSBT_BGColor2");
                PanelTxt.BackColor = TS_ThemeEngine.ColorMode(TS_Wizard.theme, "TSBT_BGColor2");
                //
                LabelDeveloper.ForeColor = TS_ThemeEngine.ColorMode(TS_Wizard.theme, "TSBT_LabelColor1");
                LabelSoftware.ForeColor = TS_ThemeEngine.ColorMode(TS_Wizard.theme, "TSBT_AccentColor");
                LabelVersion.ForeColor = TS_ThemeEngine.ColorMode(TS_Wizard.theme, "TSBT_LabelColor2");
                LabelCopyright.ForeColor = TS_ThemeEngine.ColorMode(TS_Wizard.theme, "TSBT_LabelColor2");
                //
                ...
                AboutTable.DefaultCellStyle.SelectionForeColor = TS_ThemeEngine.ColorMode(TS_Wizard.theme, "UIFEColor5");
                //
