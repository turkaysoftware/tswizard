    ...
    public partial class TS_SoftwareDetails : Form{
        ...
        private void Load_software_info_ui(int s_mode, string s_version){
            try{
                ...
                LSuppThemes_V.Text = software_lang.TSReadLangs("SoftwareDetail", "sd_theme_light") + ", " + software_lang.TSReadLangs("SoftwareDetail", "sd_theme_dark") + ", " + software_lang.TSReadLangs("SoftwareDetail", "sd_theme_system");
